...
"""
        qry = qry.format(self.schema, self.name)
        return qry
...
FOR r IN c LOOP
    ...
    fromsta := 0;
    tosta := 0;
    counter := (SELECT COUNT(*) FROM "{0}"."{1}" WHERE "RiverCode" = river);
...
class NodesTable(HecRasObject):
    def __init__(self):
        ...
        self.attrs = [('"NodeID"', "serial primary key"), ('"X"', "double precision"), ('"Y"', "double precision")]
...
"""
        ...
        if area == "Channel":
            cond = (
                'p."Station" > xs."LeftBank" * ST_Length(xs.geom) AND p."Station" < xs."RightBank" * ST_Length(xs.geom)'
            )
        elif area == "Left":
...
class BankPoints(HecRasObject):
    def __init__(self):
        ...
        self.visible = False
        self.geom_type = "POINT"
        self.attrs = [('"BankID"', "serial primary key"), ('"XsecID"', "integer"), ('"Elevation"', "double precision")]
...
class Flowpaths(HecRasObject):
    def __init__(self):
        ...
        self.order = 8
        self.geom_type = "LINESTRING"
        self.attrs = [('"FpID"', "serial primary key"), ('"LineType"', "text")]
...
class IneffAreas(HecRasObject):
    def __init__(self):
        ...
        self.attrs = [('"IneffID"', "serial primary key"), ('"Elevation"', "double precision")]
...
class BlockedObs(HecRasObject):
    def __init__(self):
        ...
        self.order = 5
        self.geom_type = "POLYGON"
        self.attrs = [('"BlockID"', "serial primary key"), ('"Elevation"', "double precision")]
...
class LanduseAreas(HecRasObject):
    def __init__(self):
        ...
        self.attrs = [('"LUID"', "serial primary key"), ('"LUCode"', "text"), ('"N_Value"', "double precision")]
...
UPDATE "{0}"."lateralstructures" AS ls
SET
   "Station" = cpnt."Length"*(1-ST_LineLocatePoint(sc.geom, cpnt.geom)) + cpnt."FromSta"
FROM
    cpnt,
    "{0}"."StreamCenterlines" AS sc
WHERE
...
class SASurface(HecRasObject):
    def __init__(self):
        ...
        self.spatial_index = False
        self.geom_type = "POINT"
        self.attrs = [('"StorageID"', "integer"), ('"Elevation"', "double precision")]
...
class SAVolume(HecRasObject):
    def __init__(self):
        ...
        self.visible = False
        self.spatial_index = False
        self.attrs = [('"StorageID"', "integer"), ('"level"', "double precision"), ('"volume"', "double precision")]
...
class BathymetryExtents(HecRasObject):
    def __init__(self):
        ...
        self.visible = False
        self.geom_type = "POLYGON"
        self.attrs = [('"BID"', "serial primary key")]
